"""Basic bootstrap confidence interval for the cv (R `boot.ci(type='basic')`)."""
...
# -------------------------------- function definition --------------------------------
def _boot_basic_cv_confidence_interval(
    data: (
        pd.Series
        | ArrayInt
        | ArrayFloat
    ...
    """Compute the basic bootstrap CI for the CV (R `boot.ci(type='basic')`).
